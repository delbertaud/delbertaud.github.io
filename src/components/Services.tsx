              ...
              <div className="lg:col-span-7 space-y-6">
                ...
                <div className="pt-4 flex flex-wrap gap-3">
                  ...
                  <button
                    ...
                    className="px-6 py-3 rounded-xl text-xs font-bold bg-slate-950 text-slate-200 hover:bg-slate-800 border border-slate-700 transition-all flex items-center gap-2"
                  >
                    <Bot className="w-4 h-4 text-cyan-400" />
                    <span>Ask AI Advisor About This Service</span>
                  </button>
                </div>
              </div>
