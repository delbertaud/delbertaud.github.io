...
import { Bot, Code2, FileText, Calculator, Briefcase, Mail, Menu, X, ShieldCheck, Sparkles } from 'lucide-react';
...
export const Header: React.FC<HeaderProps> = ({ activeTab, setActiveTab }) => {
  ...
  const navItems = [
    ...
    { id: 'ai-consultant', label: 'AI Virtual Advisor', icon: Bot, highlight: true },
