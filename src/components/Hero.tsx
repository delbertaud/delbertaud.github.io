...
import { Bot, ShieldCheck, FileText, ArrowRight, CheckCircle2, Sparkles, Cpu, Clock, DollarSign } from 'lucide-react';
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-4">
              ...
              <button
                ...
                className="px-6 py-3.5 rounded-xl text-sm font-bold bg-slate-900 text-cyan-300 hover:bg-slate-800 border border-cyan-500/40 transition-all flex items-center justify-center gap-2"
              >
                <Bot className="w-4 h-4 text-cyan-400" />
                <span>Try AI Virtual Advisor</span>
              </button>
