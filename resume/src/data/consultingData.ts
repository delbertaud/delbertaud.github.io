...
export const CASE_STUDIES: CaseStudy[] = [
  {
    id: 'case-1',
    title: 'AI-Powered Business Intelligence Pipeline',
    category: 'AI & Automation',
    clientContext: 'Mid-Market Financial Services & BI Analytics Firm',
    challenge:
      'Client received thousands of unstructured market reports, PDF financial disclosures, and customer feedback logs daily, requiring 40+ manual analyst hours per week to digest and tag into business intelligence databases.',
    solution:
      'Engineered an automated data pipeline combining n8n orchestration, Ollama local LLMs, and Google Gemini API for complex analysis. Implemented automated data validation, AirTable synchronization, and instant Slack alert triggers.',
    results: [
      'Cut manual data processing time by 92% (from 40 hrs/wk to under 3 hrs/wk)',
      'Ingested over 500,000 document pages with 99.4% field extraction accuracy',
      'Saved approximately $85,000 annually in manual labor costs',
    ],
    techStack: ['n8n', 'Ollama', 'Gemini API', 'Python', 'AirTable', 'Zapier', 'Slack API'],
    image: aiRpaImg,
  ...
  {
    id: 'case-2',
    title: 'Enterprise Alarm & Maintenance Predictive Engine',
    category: 'Software Engineering',
    clientContext: 'Telecom & Critical Infrastructure Enterprise',
    challenge:
      'Over 2 million raw alarm events were generated daily across dispersed hardware assets, creating immense "alarm noise" that masked actual equipment failures and degraded response times.',
    solution:
      'Architected a high-performance Python ingest engine feeding Elasticsearch. Developed heuristic noise-filtering algorithms to identify repeat faulty equipment and flag hardware requiring maintenance before catastrophic failure.',
    results: [
      'Filtered out 88% of false-positive transient alarm noise',
      'Reduced average mean-time-to-resolution (MTTR) for field technicians by 65%',
      'Prevented critical server outage events for enterprise accounts like Bank of America',
    ],
    techStack: ['Python', 'Elasticsearch', 'C++', 'PostgreSQL', 'Linux Shell', 'Docker'],
    image: cloudSystemsImg,
